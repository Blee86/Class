#ifndef I2CSENSOR_TASK_H
#define I2CSENSOR_TASK_H
#include "vtI2C.h"
#include "lcdTask.h"

// Structure used to pass parameters to the task
// Do not touch...
typedef struct __SensorStruct {
	vtI2CStruct *dev;
	vtLCDStruct *lcdData;
	xQueueHandle inQ;
} vtSensorStruct;
// Maximum length of a message that can be received by this task
#define vtSensorMaxLen 12
...
void vStarti2cSensorTask(vtSensorStruct *SensorData,unsigned portBASE_TYPE uxPriority, vtI2CStruct *i2c,vtLCDStruct *lcd);
//
...
portBASE_TYPE SendSensorTimerMsg(vtSensorStruct *SensorData,portTickType ticksElapsed,portTickType ticksToBlock);
//
