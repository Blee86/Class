...
//   uxPriority -- tdhe priority you want this task to be run at
...
// Send a message to change LCD Screen (External Interrupt)
// args:
//   lcdData -- a pointer to a variable of type vtLCDStruct
//   ticksToBlock -- how long the routine should wait if the queue is full
// Return:
...
portBASE_TYPE SendLCDMsgData(vtLCDStruct *lcdData,int length,char *msgbuf,portTickType ticksToBlock);
